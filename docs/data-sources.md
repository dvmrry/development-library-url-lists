...
Operating-system package mirrors (Alpine, Arch, Debian, Nix, Homebrew) are
deliberately out of scope. The lists cover language and application package
ecosystems; adding distribution mirrors is a separate decision.
